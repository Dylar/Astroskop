...
class CircumstanceViewHolder(presenter: AdapterPresenter<Circumstance>, view: View) : BaseViewHolder<Circumstance>(presenter, view) {
    ...
    override fun bindValues(circumstance: Circumstance) {
        ...
        itemView.setOnClickListener { _ -> presenter.onItemClicked(circumstance) }
